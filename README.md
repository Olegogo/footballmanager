...
Для быстрой оценки влияние матча на параметры составляет 50% при 0–2 ранее оценённых играх, 30% при 3–9 и 16% при 10 и более. Это вдвое быстрее прежних коэффициентов 25% / 15% / 8%. Дробные изменения сохраняются между играми; округление применяется при отображении. До кворума голосов снижение отключено. Рейтинг рассчитывается заново по истории, поэтому изменение формулы влияет и на уже сыгранные матчи. Полные оценки по шести параметрам по-прежнему усредняются по карьере.
